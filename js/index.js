 ...
 var xmlhttp = new XMLHttpRequest();
  ...
  xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      allStateBoundaries = JSON.parse(this.responseText);
      // document.getElementById("test").innerHTML = allStateBoundaries.features[0].geometry;
    }
  };
  xmlhttp.open("GET", "js/state_boundaries.json", true);
  xmlhttp.send();
...
var polygonGraphicAlaska = new Graphic({
  geometry: Alaska,
...
var Alabama = {
  type: "polygon",
  rings: [
[-88.1955, 35.0041], [-85.6068, 34.9918], [-85.1756, 32.8404], [-84.8927, 32.2593], [-85.0342, 32.1535], [-85.1358, 31.7947], [-85.0438, 31.5200], [-85.0836, 31.3384], [-85.1070, 31.2093], [-84.9944, 31.0023], [-87.6009, 30.9953], [-87.5926, 30.9423], [-87.6256, 30.8539], [-87.4072, 30.6745], [-87.3688, 30.4404], [-87.5240, 30.1463], [-88.3864, 30.1546], [-88.4743, 31.8939], [-88.1021, 34.8938], [-88.1721, 34.9479], [-88.1461, 34.9107]
  ]
};

var simpleFillSymbolAlabama = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicAlabama = new Graphic({
  geometry: Alabama,
  symbol: simpleFillSymbolAlabama
})
...
var popupsAlabama = new Graphic({
  geometry: Alabama,
  symbol: simpleFillSymbolAlabama,
  attributes: attributesAlabama,
  popupTemplate: popupAlabama
});

graphicsLayer.add(popupsAlabama);

var Arkansas = {
  type: "polygon",
  rings: [
[-94.0416, 33.0225], [-91.2057, 33.0075], [-91.1989, 33.1180], [-91.1041, 33.1824], [-91.1343, 33.3053], [-91.1646, 33.4211], [-91.2263, 33.4337], [-91.2524, 33.5403], [-91.1797, 33.6112], [-91.2524, 33.6855], [-91.1261, 33.6946], [-91.1412, 33.7883], [-91.0451, 33.7700], [-91.0341, 33.8328], [-91.0863, 33.9399], [-90.9256, 34.0208], [-90.9036, 34.0856], [-90.9586, 34.1345], [-90.9132, 34.1675], [-90.8501, 34.1380], [-90.9325, 34.2311], [-90.6935, 34.3446], [-90.5603, 34.4409], [-90.5548, 34.5348], [-90.5768, 34.5959], [-90.5301, 34.7213], [-90.5328, 34.7574], [-90.4546, 34.8780], [-90.3529, 34.8454], [-90.2911, 34.8690], [-90.3104, 35.0255], [-90.2843, 35.1154], [-90.1772, 35.1323], [-90.1112, 35.1985], [-90.1524, 35.2826], [-90.1332, 35.4383], [-90.0206, 35.5579], [-89.9780, 35.6740], [-89.9547, 35.7287], [-89.6594, 35.9169], [-89.6883, 35.9658], [-89.7130, 36.0013], [-90.3735, 35.9958], [-90.2664, 36.1268], [-90.0934, 36.2875], [-90.0742, 36.3892], [-90.1511, 36.4180], [-90.1566, 36.4997], [-94.6198, 36.4986], [-94.4412, 35.3801], [-94.4893, 33.6318], [-94.4522, 33.6421], [-94.4000, 33.5597], [-94.2462, 33.5883], [-94.1885, 33.5872], [-94.0375, 33.5345], [-94.0430, 33.4314], [-94.0430, 33.0213]
  ]
};

var simpleFillSymbolArkansas = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicArkansas = new Graphic({
  geometry: Arkansas,
  symbol: simpleFillSymbolArkansas
})
...
var polygonGraphicArizona = new Graphic({
  geometry: Arizona,
  symbol: simpleFillSymbolArizona
})
...
var polygonGraphicCalifornia = new Graphic({
  geometry: California,
  symbol: simpleFillSymbolCalifornia
})
...
var popupsCalifornia = new Graphic({
  geometry: California,
  symbol: simpleFillSymbolCalifornia,
  attributes: attributesCalifornia,
  popupTemplate: popupCalifornia
});

graphicsLayer.add(popupsCalifornia);

var Colorado = {
  type: "polygon",
  rings: [
[-109.0448, 37.0004], [-102.0424, 36.9949], [-102.0534, 41.0006], [-109.0489, 40.9996], [-109.0448, 37.0004]
  ]
};

var simpleFillSymbolColorado = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicColorado = new Graphic({
  geometry: Colorado,
  symbol: simpleFillSymbolColorado
})
...
var popupsColorado = new Graphic({
  geometry: Colorado,
  symbol: simpleFillSymbolColorado,
  attributes: attributesColorado,
  popupTemplate: popupColorado
});

graphicsLayer.add(popupsColorado);

var Connecticut = {
  type: "polygon",
  rings: [
[-73.4875, 42.0498], [-73.4247, 42.0511], [-72.8146, 42.0371], [-72.8174, 41.9983], [-72.7638, 42.0044], [-72.7563, 42.0360], [-72.6945, 42.0368], [-72.6086, 42.0309], [-72.6059, 42.0269], [-72.5784, 42.0269], [-72.5729, 42.0350], [-72.4026, 42.0350], [-71.7984, 42.0248], [-71.7874, 41.6832], [-71.7984, 41.4165], [-71.8341, 41.3892], [-71.8526, 41.3273], [-71.8938, 41.3309], [-71.9302, 41.3103], [-72.0195, 41.2907], [-72.0827, 41.2618], [-72.4322, 41.1962], [-73.0007, 41.0866], [-73.2493, 41.0255], [-73.6132, 40.9509], [-73.6606, 40.9830], [-73.6723, 41.0338], [-73.7272, 41.1011], [-73.4834, 41.2153], [-73.5507, 41.2953], [-73.5329, 41.4906], [-73.4875, 42.0493]
  ]
};

var simpleFillSymbolConnecticut = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicConnecticut = new Graphic({
  geometry: Connecticut,
  symbol: simpleFillSymbolConnecticut
})
...
var popupsConnecticut = new Graphic({
  geometry: Connecticut,
  symbol: simpleFillSymbolConnecticut,
  attributes: attributesConnecticut,
  popupTemplate: popupConnecticut
});

graphicsLayer.add(popupsConnecticut);

var Delaware = {
  type: "polygon",
  rings: [
[-75.7919, 39.7188], [-75.7837, 39.5210], [-75.7288, 38.9081], [-75.7068, 38.5911], [-75.6944, 38.4600], [-74.8608, 38.4482], [-74.8526, 38.8654], [-75.0504, 38.8451], [-75.1678, 39.0565], [-75.3236, 39.2525], [-75.4610, 39.3662], [-75.5592, 39.4542], [-75.5578, 39.4908], [-75.5118, 39.5713], [-75.5557, 39.6284], [-75.3937, 39.8106], [-75.4692, 39.8249], [-75.6477, 39.8296], [-75.7906, 39.7199]
  ]
};

var simpleFillSymbolDelaware = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicDelaware = new Graphic({
  geometry: Delaware,
  symbol: simpleFillSymbolDelaware
})
...
var polygonGraphicFlorida = new Graphic({
  geometry: Florida,
  symbol: simpleFillSymbolFlorida
})
...
var polygonGraphicGeorgia = new Graphic({
  geometry: Georgia,
  symbol: simpleFillSymbolGeorgia
})
...
var popupsGeorgia = new Graphic({
  geometry: Georgia,
  symbol: simpleFillSymbolGeorgia,
  attributes: attributesGeorgia,
  popupTemplate: popupGeorgia
});

graphicsLayer.add(popupsGeorgia);

var Hawaii = {
  type: "polygon",
  rings: [
[-154.6284, 19.5158], [-154.8235, 19.8894], [-155.0391, 20.1849], [-155.5952, 20.3910], [-155.7930, 20.8614], [-156.1858, 21.0948], [-156.6595, 21.3597], [-157.1182, 21.4748], [-157.5247, 21.5515], [-157.8186, 21.8832], [-159.2180, 22.3386], [-159.7508, 22.3374], [-160.1422, 22.1493], [-160.3922, 21.8857], [-160.3249, 21.6025], [-159.9939, 21.7276], [-159.4295, 21.6932], [-158.1784, 21.1037], [-157.4629, 20.8152], [-157.2171, 20.6803], [-156.8285, 20.3408], [-156.5456, 20.2931], [-156.1418, 20.1643], [-156.2393, 19.9308], [-156.1432, 19.2826], [-156.1212, 18.9881], [-155.7120, 18.7100], [-155.3673, 18.8829], [-154.8839, 19.2048], [-154.6271, 19.5158]
  ]
};

var simpleFillSymbolHawaii = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicHawaii = new Graphic({
  geometry: Hawaii,
  symbol: simpleFillSymbolHawaii
})
...
var popupsHawaii = new Graphic({
  geometry: Hawaii,
  symbol: simpleFillSymbolHawaii,
  attributes: attributesHawaii,
  popupTemplate: popupHawaii
});

graphicsLayer.add(popupsHawaii);

var Iowa = {
  type: "polygon",
  rings: [
[-95.7623, 40.5848], [-93.5445, 40.5785], [-91.7372, 40.6129], [-91.6768, 40.5545], [-91.6246, 40.5451], [-91.4365, 40.3622], [-91.3623, 40.4637], [-91.4021, 40.5482], [-91.1124, 40.6931], [-91.1028, 40.8107], [-90.9668, 40.9218], [-91.0121, 41.1642], [-91.1082, 41.2406], [-91.0451, 41.4067], [-90.7086, 41.4510], [-90.4793, 41.5178], [-90.3419, 41.5908], [-90.2788, 41.7457], [-90.2074, 41.8164], [-90.1538, 41.9023], [-90.1744, 42.0962], [-90.2692, 42.1441], [-90.4298, 42.2905], [-90.5370, 42.4093], [-90.6400, 42.5217], [-90.7127, 42.6360], [-90.7883, 42.6956], [-91.0533, 42.7712], [-91.0904, 42.8448], [-91.1398, 42.9082], [-91.1549, 43.0609], [-91.1522, 43.1391], [-91.0547, 43.2882], [-91.2057, 43.3322], [-91.2236, 43.4140], [-91.2305, 43.5008], [-96.5973, 43.4998], [-96.6110, 43.4818], [-96.5245, 43.3871], [-96.5533, 43.2232], [-96.4421, 43.1301], [-96.5479, 42.9243], [-96.6357, 42.7188], [-96.5561, 42.6158], [-96.4847, 42.5055], [-96.3995, 42.4599], [-96.4050, 42.3667], [-96.3446, 42.2722], [-96.3625, 42.2051], [-96.2416, 41.9983], [-96.1372, 41.9513], [-96.0741, 41.7662], [-96.0988, 41.6267], [-95.9477, 41.4561], [-95.8804, 41.2819], [-95.8653, 41.0338], [-95.8365, 40.8346], [-95.8461, 40.6775], [-95.7610, 40.5837]
  ]
};

var simpleFillSymbolIowa = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicIowa = new Graphic({
  geometry: Iowa,
  symbol: simpleFillSymbolIowa
})
...
var polygonGraphicIdaho = new Graphic({
  geometry: Idaho,
  symbol: simpleFillSymbolIdaho
})
...
var polygonGraphicIllinois = new Graphic({
  geometry: Illinois,
  symbol: simpleFillSymbolIllinois
})
...
var polygonGraphicIndiana = new Graphic({
  geometry: Indiana,
  symbol: simpleFillSymbolIndiana
})
...
var popupsIndiana = new Graphic({
  geometry: Indiana,
  symbol: simpleFillSymbolIndiana,
  attributes: attributesIndiana,
  popupTemplate: popupIndiana
});

graphicsLayer.add(popupsIndiana);

var Kansas = {
  type: "polygon",
  rings: [
[-102.0506, 40.0034], [-102.0506, 40.0034], [-102.0438, 36.9927], [-94.6211, 36.9982], [-94.6046, 38.8803], [-94.6143, 39.0789], [-94.6184, 39.1971], [-94.7255, 39.1673], [-94.8793, 39.2759], [-95.0990, 39.5612], [-94.8807, 39.7283], [-94.8930, 39.8286], [-94.9342, 39.8823], [-95.0098, 39.8971], [-95.0922, 39.8760], [-95.2213, 39.9445], [-95.3036, 40.0087], [-102.0506, 40.0024]
  ]
};

var simpleFillSymbolKansas = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicKansas = new Graphic({
  geometry: Kansas,
  symbol: simpleFillSymbolKansas
})
...
var polygonGraphicKentucky = new Graphic({
  geometry: Kentucky,
  symbol: simpleFillSymbolKentucky
})
...
var polygonGraphicLouisiana = new Graphic({
  geometry: Louisiana,
  symbol: simpleFillSymbolLouisiana
})
...
var polygonGraphicMassachusetts = new Graphic({
  geometry: Massachusetts,
  symbol: simpleFillSymbolMassachusetts
})
...
var polygonGraphicMaryland = new Graphic({
  geometry: Maryland,
  symbol: simpleFillSymbolMaryland
})
...
var popupsMaryland = new Graphic({
  geometry: Maryland,
  symbol: simpleFillSymbolMaryland,
  attributes: attributesMaryland,
  popupTemplate: popupMaryland
});

graphicsLayer.add(popupsMaryland);

var Maine = {
  type: "polygon",
  rings: [
[-71.0129, 45.3425], [-70.9525, 45.3328], [-70.8618, 45.2294], [-70.8247, 45.3917], [-70.7808, 45.4274], [-70.6380, 45.3830], [-70.7190, 45.5092], [-70.5721, 45.6544], [-70.3894, 45.7292], [-70.4169, 45.7924], [-70.2493, 45.9368], [-70.3098, 45.9597], [-70.2946, 46.0923], [-70.2589, 46.0989], [-70.2466, 46.1342], [-70.2905, 46.1903], [-70.2466, 46.2710], [-70.2040, 46.3270], [-70.0571, 46.4151], [-69.9994, 46.6956], [-69.2303, 47.4550], [-69.0381, 47.4132], [-69.0504, 47.2578], [-68.8843, 47.1748], [-68.6206, 47.2643], [-68.3350, 47.3546], [-68.1564, 47.3165], [-67.8804, 47.1038], [-67.7898, 47.0664], [-67.7802, 45.9359], [-67.7527, 45.9177], [-67.8090, 45.7599], [-67.6524, 45.6208], [-67.4533, 45.5987], [-67.4176, 45.5044], [-67.5014, 45.4823], [-67.4231, 45.3714], [-67.4863, 45.2768], [-67.3434, 45.1297], [-67.2487, 45.1830], [-67.1223, 45.1230], [-66.9672, 44.8315], [-66.8628, 44.7409], [-67.3105, 44.4945], [-67.9051, 44.3268], [-68.6673, 43.8702], [-68.8431, 43.7274], [-69.7137, 43.6639], [-70.0818, 43.5625], [-70.5569, 42.9182], [-70.7108, 43.0649], [-70.8302, 43.1391], [-70.8179, 43.2292], [-70.9799, 43.3631], [-70.9717, 43.5675], [-71.0829, 45.3029]
  ]
};

var simpleFillSymbolMaine = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicMaine = new Graphic({
  geometry: Maine,
  symbol: simpleFillSymbolMaine
})
...
var polygonGraphicMichigan = new Graphic({
  geometry: Michigan,
  symbol: simpleFillSymbolMichigan
})
...
var polygonGraphicMinnesota = new Graphic({
  geometry: Minnesota,
  symbol: simpleFillSymbolMinnesota
})
...
var polygonGraphicMissouri = new Graphic({
  geometry: Missouri,
  symbol: simpleFillSymbolMissouri
})
...
var polygonGraphicMississippi = new Graphic({
  geometry: Mississippi,
  symbol: simpleFillSymbolMississippi
})
...
var polygonGraphicMontana = new Graphic({
  geometry: Montana,
  symbol: simpleFillSymbolMontana
})
...
var polygonGraphicNorthCarolina = new Graphic({
  geometry: NorthCarolina,
  symbol: simpleFillSymbolNorthCarolina
})
...
var popupsNorthCarolina = new Graphic({
  geometry: NorthCarolina,
  symbol: simpleFillSymbolNorthCarolina,
  attributes: attributesNorthCarolina,
  popupTemplate: popupNorthCarolina
});

graphicsLayer.add(popupsNorthCarolina);

var NorthDakota = {
  type: "polygon",
  rings: [
[-104.0501, 48.9955], [-104.0446, 45.9445], [-96.5671, 45.9340], [-96.6028, 46.3242], [-96.7978, 46.6636], [-96.7896, 46.8602], [-96.7896, 46.9503], [-96.8335, 47.1300], [-96.8335, 47.2345], [-96.8555, 47.4132], [-96.8555, 47.5469], [-96.8774, 47.6506], [-97.0601, 47.9918], [-97.1260, 48.1267], [-97.1109, 48.2859], [-97.1233, 48.4301], [-97.1425, 48.5530], [-97.0999, 48.6765], [-97.1356, 48.7326], [-97.1727, 48.7951], [-97.2290, 48.9081], [-97.2331, 48.9982], [-104.0501, 48.9946]
  ]
};

var simpleFillSymbolNorthDakota = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicNorthDakota = new Graphic({
  geometry: NorthDakota,
  symbol: simpleFillSymbolNorthDakota
})
...
var popupsNorthDakota = new Graphic({
  geometry: NorthDakota,
  symbol: simpleFillSymbolNorthDakota,
  attributes: attributesNorthDakota,
  popupTemplate: popupNorthDakota
});

graphicsLayer.add(popupsNorthDakota);
...
var polygonGraphicNebraska = new Graphic({
  geometry: Nebraska,
  symbol: simpleFillSymbolNebraska
})
...
var polygonGraphicNewHampshire = new Graphic({
  geometry: NewHampshire,
  symbol: simpleFillSymbolNewHampshire
})
...
var polygonGraphicNewJersey = new Graphic({
  geometry: NewJersey,
  symbol: simpleFillSymbolNewJersey
})
...
var popupsNewJersey = new Graphic({
  geometry: NewJersey,
  symbol: simpleFillSymbolNewJersey,
  attributes: attributesNewJersey,
  popupTemplate: popupNewJersey
});

graphicsLayer.add(popupsNewJersey);

var NewMexico = {
  type: "polygon",
  rings: [
[-109.0448, 36.9971], [-109.0489, 31.3337], [-108.2140, 31.3349], [-108.2071, 31.7795], [-106.5317, 31.7830], [-106.6223, 32.0034], [-103.0696, 31.9999], [-103.0023, 36.9982], [-109.0475, 36.9982]
  ]
};

var simpleFillSymbolNewMexico = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicNewMexico = new Graphic({
  geometry: NewMexico,
  symbol: simpleFillSymbolNewMexico
})
...
var popupsNewMexico = new Graphic({
  geometry: NewMexico,
  symbol: simpleFillSymbolNewMexico,
  attributes: attributesNewMexico,
  popupTemplate: popupNewMexico
});

graphicsLayer.add(popupsNewMexico);
...
var polygonGraphicNevada = new Graphic({
  geometry: Nevada,
  symbol: simpleFillSymbolNevada
})
...
var polygonGraphicNewYork = new Graphic({
  geometry: NewYork,
  symbol: simpleFillSymbolNewYork
})
...
var polygonGraphicOhio = new Graphic({
  geometry: Ohio,
  symbol: simpleFillSymbolOhio
})
...
var polygonGraphicOklahoma = new Graphic({
  geometry: Oklahoma,
  symbol: simpleFillSymbolOklahoma
})
...
var polygonGraphicOregon = new Graphic({
  geometry: Oregon,
  symbol: simpleFillSymbolOregon
})
...
var popupsOregon = new Graphic({
  geometry: Oregon,
  symbol: simpleFillSymbolOregon,
  attributes: attributesOregon,
  popupTemplate: popupOregon
});

graphicsLayer.add(popupsOregon);

var Pennsylvania = {
  type: "polygon",
  rings: [
[-80.5174, 42.3261], [-80.0821, 42.3961], [-79.7621, 42.5167], [-79.7607, 42.0003], [-75.3580, 41.9983], [-75.2673, 41.9431], [-75.1794, 41.8696], [-75.0586, 41.7713], [-75.0366, 41.6729], [-75.0641, 41.6021], [-74.9927, 41.5086], [-74.7935, 41.4283], [-74.7070, 41.3933], [-74.8608, 41.2282], [-75.1355, 40.9830], [-75.0490, 40.8554], [-75.1904, 40.6806], [-75.2124, 40.5639], [-75.1025, 40.5743], [-75.0600, 40.5013], [-75.0655, 40.4208], [-74.9776, 40.4072], [-74.9432, 40.3392], [-74.8389, 40.2628], [-74.7221, 40.1495], [-75.0929, 39.9592], [-75.2577, 39.8370], [-75.4321, 39.8128], [-75.6477, 39.8317], [-75.7892, 39.7199], [-80.5243, 39.7220], [-80.5202, 42.3240]
  ]
};

var simpleFillSymbolPennsylvania = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicPennsylvania = new Graphic({
  geometry: Pennsylvania,
  symbol: simpleFillSymbolPennsylvania
})
...
var popupsPennsylvania = new Graphic({
  geometry: Pennsylvania,
  symbol: simpleFillSymbolPennsylvania,
  attributes: attributesPennsylvania,
  popupTemplate: popupPennsylvania
});

graphicsLayer.add(popupsPennsylvania);

var RhodeIsland = {
  type: "polygon",
  rings: [
[-71.0568, 41.3706], [-71.0541, 41.3706], [-71.1447, 41.6339], [-71.1942, 41.6791], [-71.2793, 41.7611], [-71.3315, 41.7775], [-71.3425, 41.7918], [-71.3507, 41.8225], [-71.3370, 41.8512], [-71.3397, 41.8880], [-71.3837, 41.9288], [-71.3795, 42.0156], [-71.7984, 42.0064], [-71.7874, 41.6750], [-71.7984, 41.4530], [-71.8492, 41.3943], [-71.8520, 41.3315], [-71.9041, 41.3057], [-71.7915, 41.1849], [-71.4084, 41.2665]
  ]
};

var simpleFillSymbolRhodeIsland = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicRhodeIsland = new Graphic({
  geometry: RhodeIsland,
  symbol: simpleFillSymbolRhodeIsland
})
...
var popupsRhodeIsland = new Graphic({
  geometry: RhodeIsland,
  symbol: simpleFillSymbolRhodeIsland,
  attributes: attributesRhodeIsland,
  popupTemplate: popupRhodeIsland
});

graphicsLayer.add(popupsRhodeIsland);

var SouthCarolina = {
  type: "polygon",
  rings: [
[-80.7001, 32.0488], [-80.8978, 32.0453], [-81.1134, 32.1105], [-81.1423, 32.2058], [-81.1821, 32.3846], [-81.1986, 32.4576], [-81.2769, 32.5283], [-81.4087, 32.5838], [-81.4183, 32.6926], [-81.4746, 32.8242], [-81.5117, 32.9465], [-81.5034, 33.0098], [-81.6010, 33.0777], [-81.7122, 33.1238], [-81.8289, 33.2065], [-81.9319, 33.3443], [-82.0280, 33.4830], [-82.1475, 33.5860], [-82.2437, 33.6878], [-82.2437, 33.7609], [-82.3576, 33.8305], [-82.5018, 33.9308], [-82.5471, 33.9650], [-82.6625, 34.0947], [-82.7216, 34.1664], [-82.7930, 34.3434], [-82.8905, 34.4647], [-82.9893, 34.4760], [-83.0855, 34.5281], [-83.3121, 34.6581], [-83.3588, 34.7326], [-83.2983, 34.8318], [-83.1459, 34.9276], [-83.1047, 34.9996], [-82.7779, 35.0817], [-82.3920, 35.2075], [-82.2203, 35.1974], [-81.0379, 35.1480], [-81.0324, 35.0446], [-80.9322, 35.1019], [-80.7811, 34.9344], [-80.7948, 34.8194], [-79.6756, 34.8048], [-78.9560, 34.2016], [-78.4836, 33.7951], [-78.7871, 33.6489], [-79.0837, 33.2019], [-79.4476, 32.7607], [-79.8116, 32.5225], [-80.1508, 32.3556], [-80.4240, 32.2012], [-80.7001, 32.0500]
  ]
};

var simpleFillSymbolSouthCarolina = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicSouthCarolina = new Graphic({
  geometry: SouthCarolina,
  symbol: simpleFillSymbolSouthCarolina
})
...
var polygonGraphicSouthDakota = new Graphic({
  geometry: SouthDakota,
  symbol: simpleFillSymbolSouthDakota
})
...
var popupsSouthDakota = new Graphic({
  geometry: SouthDakota,
  symbol: simpleFillSymbolSouthDakota,
  attributes: attributesSouthDakota,
  popupTemplate: popupSouthDakota
});

graphicsLayer.add(popupsSouthDakota);

var Tennessee = {
  type: "polygon",
  rings: [
[-88.0678, 36.6739], [-87.8522, 36.6354], [-83.6787, 36.6023], [-81.9402, 36.5946], [-81.9209, 36.6144], [-81.6518, 36.6111], [-81.7163, 36.3295], [-81.7973, 36.3516], [-81.9072, 36.2974], [-82.0308, 36.1212], [-82.1255, 36.1024], [-82.1475, 36.1434], [-82.2450, 36.1323], [-82.3521, 36.1168], [-82.4167, 36.0702], [-82.5389, 35.9669], [-82.6076, 35.9702], [-82.6378, 36.0602], [-82.7751, 35.9925], [-82.8177, 35.9169], [-82.9042, 35.8623], [-83.0017, 35.7755], [-83.2393, 35.7131], [-83.4961, 35.5635], [-83.6938, 35.5501], [-83.8284, 35.5233], [-83.8847, 35.5065], [-84.0248, 35.4014], [-84.0276, 35.2905], [-84.1113, 35.2322], [-84.2294, 35.2624], [-84.2926, 35.2198], [-84.3201, 34.9884], [-90.3131, 34.9996], [-90.2843, 35.1233], [-90.1758, 35.1379], [-90.1112, 35.1985], [-90.1524, 35.2849], [-90.1346, 35.4372], [-90.0192, 35.5568], [-89.9547, 35.7343], [-89.7638, 35.8579], [-89.6635, 35.9180], [-89.7130, 35.9947], [-89.6759, 36.0902], [-89.5894, 36.1279], [-89.6484, 36.1856], [-89.7006, 36.2343], [-89.5331, 36.2531], [-89.6210, 36.2996], [-89.5784, 36.3494], [-89.5180, 36.3406], [-89.5345, 36.4964], [-89.3051, 36.5107], [-88.1667, 36.4986], [-88.0692, 36.4997], [-88.0637, 36.6871]
  ]
};

var simpleFillSymbolTennessee = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicTennessee = new Graphic({
  geometry: Tennessee,
  symbol: simpleFillSymbolTennessee
})
...
var polygonGraphicTexas = new Graphic({
  geometry: Texas,
  symbol: simpleFillSymbolTexas
})
...
var popupsTexas = new Graphic({
  geometry: Texas,
  symbol: simpleFillSymbolTexas,
  attributes: attributesTexas,
  popupTemplate: popupTexas
});

graphicsLayer.add(popupsTexas);

var Utah = {
  type: "polygon",
  rings: [
[-114.0491, 36.9982], [-109.0462, 37.0026], [-109.0503, 40.9986], [-111.0471, 41.0006], [-111.0498, 41.9993], [-114.0395, 41.9901], [-114.0504, 37.0015]
  ]
};

var simpleFillSymbolUtah = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicUtah = new Graphic({
  geometry: Utah,
  symbol: simpleFillSymbolUtah
})
...
var polygonGraphicVirginia = new Graphic({
  geometry: Virginia,
  symbol: simpleFillSymbolVirginia
})
...
var polygonGraphicVermont = new Graphic({
  geometry: Vermont,
  symbol: simpleFillSymbolVermont
})
...
var polygonGraphicWashington = new Graphic({
  geometry: Washington,
  symbol: simpleFillSymbolWashington
})
...
var polygonGraphicWisconsin = new Graphic({
  geometry: Wisconsin,
  symbol: simpleFillSymbolWisconsin
})
...
var popupsWisconsin = new Graphic({
  geometry: Wisconsin,
  symbol: simpleFillSymbolWisconsin,
  attributes: attributesWisconsin,
  popupTemplate: popupWisconsin
});

graphicsLayer.add(popupsWisconsin);

var WestVirginia = {
  type: "polygon",
  rings: [
[-79.4765, 39.7188], [-79.4806, 39.2057], [-79.0576, 39.4871], [-78.9725, 39.4394], [-78.7747, 39.6438], [-78.6703, 39.5369], [-78.5742, 39.5210], [-78.4644, 39.5210], [-78.4094, 39.6015], [-78.3517, 39.6395], [-78.2817, 39.6205], [-78.2405, 39.6839], [-78.1732, 39.6935], [-77.8835, 39.5972], [-77.7859, 39.4987], [-77.7310, 39.3279], [-77.8271, 39.1279], [-78.3421, 39.4563], [-78.3408, 39.3407], [-78.4341, 39.1918], [-78.4053, 39.1652], [-78.5715, 39.0299], [-78.5522, 39.0160], [-78.7843, 38.8846], [-78.8722, 38.7669], [-78.9917, 38.8451], [-79.0974, 38.7102], [-79.1029, 38.6555], [-79.3007, 38.4106], [-79.4792, 38.4600], [-79.5314, 38.5342], [-79.6481, 38.5868], [-79.6962, 38.4869], [-79.6989, 38.4213], [-79.7690, 38.3557], [-79.7937, 38.2813], [-79.9365, 38.1518], [-79.9818, 38.0232], [-80.1370, 37.8835], [-80.2592, 37.7295], [-80.2881, 37.6795], [-80.2194, 37.6295], [-80.3224, 37.5391], [-80.2881, 37.5315], [-80.3032, 37.4988], [-80.4776, 37.4182], [-80.5119, 37.4814], [-80.7715, 37.3691], [-80.8635, 37.4214], [-80.8525, 37.3429], [-81.0516, 37.2872], [-81.2741, 37.2598], [-81.3675, 37.3254], [-81.5543, 37.2019], [-81.6724, 37.1953], [-81.7685, 37.2697], [-81.8701, 37.3003], [-81.9333, 37.3636], [-81.9772, 37.4574], [-82.0308, 37.4912], [-82.1558, 37.6142], [-82.3535, 37.8054], [-82.5513, 38.0481], [-82.6392, 38.1864], [-82.5966, 38.3761], [-82.4854, 38.4106], [-82.3412, 38.4407], [-82.2876, 38.5890], [-82.1764, 38.5976], [-82.2148, 38.7980], [-82.0280, 39.0160], [-81.9649, 38.9615], [-81.8756, 38.8750], [-81.7671, 38.9370], [-81.7657, 39.0117], [-81.7520, 39.0800], [-81.7465, 39.1790], [-81.5872, 39.2642], [-81.4499, 39.3969], [-81.3675, 39.3481], [-81.2370, 39.4012], [-81.1093, 39.4691], [-81.0104, 39.5644], [-80.9198, 39.6120], [-80.8319, 39.6522], [-80.8072, 39.8054], [-80.7893, 39.8802], [-80.7990, 39.8518], [-80.7495, 40.0980], [-80.7262, 40.2282], [-80.6918, 40.3926], [-80.6451, 40.5910], [-80.5188, 40.6338], [-80.5174, 39.7241], [-79.4778, 39.7209]
  ]
};

var simpleFillSymbolWestVirginia = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicWestVirginia = new Graphic({
  geometry: WestVirginia,
  symbol: simpleFillSymbolWestVirginia
})
...
var popupsWestVirginia = new Graphic({
  geometry: WestVirginia,
  symbol: simpleFillSymbolWestVirginia,
  attributes: attributesWestVirginia,
  popupTemplate: popupWestVirginia
});

graphicsLayer.add(popupsWestVirginia);

var Wyoming = {
  type: "polygon",
  rings: [
[-104.0556, 41.0037], [-104.0584, 44.9949], [-111.0539, 44.9998], [-111.0457, 40.9986], [-104.0556, 41.0006]
  ]
};

var simpleFillSymbolWyoming = {
  type: "simple-fill",
  color: [227, 139, 79, 0.8],
  outline: {
    color: [255, 255, 255],
...
var polygonGraphicWyoming = new Graphic({
  geometry: Wyoming,
  symbol: simpleFillSymbolWyoming
})
...
var popupsWyoming = new Graphic({
  geometry: Wyoming,
  symbol: simpleFillSymbolWyoming,
  attributes: attributesWyoming,
  popupTemplate: popupWyoming
});
